...
public class RegularExpressTest {
	public static void main(String[] args) {
		...
		// 정규표현식
		String patt = "b[a-z]*"; // b가 맨 앞에 반드시 있고 []안에 있는 단어가 * = 0개 이상
		...
		// 자주 사용하는 정규표현식
		String ptt1 = "^[a-zA-Z0-9]*$"; // 회원가입시 ID 영어, 숫자 입력 정규표현식
		String ptt2 = "^[가-힣]*$"; // 회원가입시 이름 입력 정규표현식
		String ptt3 = "(01\\d{1})-(\\d{3,4})-(\\d{4})"; // 회원가입시 휴대폰 정규표현식
		String ptt4 = "(\\w+)@(\\w+).(\\w+)"; // 회원가입시 이메일 입력 정규표현식
